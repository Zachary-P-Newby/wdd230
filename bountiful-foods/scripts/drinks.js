...
function displayOrderOutput(){
  ...
  orderMessageBox.style.padding = "2vh 2vw"
  ...
  nutritions.innerHTML = `<li>Total Calories: ${Math.round(totalCalories)}</li><li>Total Carbohydrates: ${Math.round(totalCarbs)} Grams</li><li>Total Protien: ${Math.round(totalProtien)} Grams</li><li>Total Fat: ${Math.round(totalFat)} Grams</li><li>Total Sugar: ${Math.round(totalSugar)} Grams</li>`;
